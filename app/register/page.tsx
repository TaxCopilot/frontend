...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Scale, FileSearch, Sparkles, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen flex font-sans bg-background-light">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[50%] bg-gradient-to-br from-primary via-primary-dark to-[#0a2a1f] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-white/15 backdrop-blur-sm border border-white/20 flex items-center justify-center font-serif font-bold text-white text-base shadow-lg">T</div>
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/15 rounded-full px-3 py-1 mb-6">
            ...
            <span className="text-white/80 text-xs font-medium tracking-wide">Join thousands of tax professionals</span>
          </div>
          <h1 className="text-4xl xl:text-5xl font-serif font-bold text-white leading-tight mb-4">
            Start Working<br />Smarter Today
          </h1>
          <p className="text-white/60 text-[15px] leading-relaxed max-w-sm">
            Create your free account and get instant access to AI-powered tax notice analysis.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 py-12 relative overflow-y-auto overflow-x-hidden">
        ...
        <div className="w-full max-w-[380px] relative z-10">
          ...
          {/* Heading */}
          <div className="mb-8">
            <h2 className="text-[26px] font-bold text-text-heading tracking-tight">Create your account</h2>
            <p className="text-text-sub text-sm mt-1.5">Get started for free — no credit card required</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[13px] font-medium text-text-heading mb-1.5" htmlFor="name">Full Name</label>
            ...
            <div>
              <label className="block text-[13px] font-medium text-text-heading mb-1.5" htmlFor="email">Email Address</label>
              <div className="relative">
                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-text-light pointer-events-none" />
                <input
                  id="email" name="email" type="email" required placeholder="name@firm.com"
            ...
            <div>
              <label className="block text-[13px] font-medium text-text-heading mb-1.5" htmlFor="password">Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-text-light pointer-events-none" />
                <input
                  id="password" name="password" type={showPassword ? 'text' : 'password'} required minLength={6} placeholder="Min. 6 characters"
            ...
            <div>
              <label className="block text-[13px] font-medium text-text-heading mb-1.5" htmlFor="confirmPassword">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-text-light pointer-events-none" />
                <input
                  id="confirmPassword" name="confirmPassword" type={showPassword ? 'text' : 'password'} required placeholder="Re-enter password"
